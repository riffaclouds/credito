...
<body>
	...
	<div id="menuBar">
		<ul>
			<li class="menuItems"><a href="/databasePlayground/">Home</a></li>
			<li class="menuItems"><a href="/databasePlayground/">Organisaties</a></li>
			<li class="menuItems"><a href="UserControllerServlet">Gebruikers</a></li>
			<li class="menuItems"><a href="/databasePlayground/">Veilig betalen</a></li>
			<li class="menuItems"><a href="UserControllerServlet">Mijn Credito</a></li>
		</ul>
	</div>
